...
namespace ToolingPackage
{
    ...
    {
        private Extensions.AccessModifier _accessModifier = Extensions.AccessModifier.Public;
        private string _name = string.Empty;
        private string _returnType = string.Empty;
        private SortedList<string, string> _parameters;
        private string _body = string.Empty;

        public Extensions.AccessModifier AccessModifier { get => this._accessModifier; }
        ...
        public FunctionTemplate SetAccessModifier(Extensions.AccessModifier accessModifier)
        {
        ...
        public FunctionTemplate SetBody(string body)
        {
            this._body = body;
            return this;
        }
        ...
        public string ToStringForClassFile()
        {
            ...
            sb.Append(this.AccessModifier.ToLower());
